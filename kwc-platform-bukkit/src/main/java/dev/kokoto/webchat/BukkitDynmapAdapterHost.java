 ...
 * BukkitDynmapAdapterHost는 loader-neutral core와 실제 서버/맵 플랫폼 구현 사이의 경계 인터페이스 또는 bridge다.
 * BukkitDynmapAdapterHost is a boundary interface/bridge between loader-neutral core and the concrete server/map-platform implementation.
 *
...
/** Bukkit resource/filesystem/logging bridge for the loader-neutral Dynmap adapter. */
public final class BukkitDynmapAdapterHost implements DynmapAdapterHost {
    private final KokotoWebChatPlugin plugin;
    private final CoreLogger logger;

    public BukkitDynmapAdapterHost(KokotoWebChatPlugin plugin) {
