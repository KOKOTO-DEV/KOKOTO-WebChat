 ...
 * EventAnnouncementListener는 Bukkit event bus에서 게임 이벤트를 받아 KWC core 이벤트/메시지로 변환하는 listener다.
 * EventAnnouncementListener listens on the Bukkit event bus and translates game events into KWC core events/messages.
 *
