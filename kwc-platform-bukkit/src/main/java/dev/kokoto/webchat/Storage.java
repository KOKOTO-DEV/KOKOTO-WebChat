...
public class Storage implements WebChatStorage {
    ...
    public Storage(KokotoWebChatPlugin plugin) {
        this.plugin = plugin;
    ...
    private static PinnedMessage pinnedMessageFromSection(ConfigurationSection s) {
