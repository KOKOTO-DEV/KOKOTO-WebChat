 ...
 * DiscordBridge는 Bukkit/Paper 런타임에서 core 기능을 실제 Bukkit API와 연결하는 플랫폼 구현 코드다.
 * DiscordBridge is Bukkit/Paper platform implementation code connecting core features to concrete Bukkit APIs.
 *
