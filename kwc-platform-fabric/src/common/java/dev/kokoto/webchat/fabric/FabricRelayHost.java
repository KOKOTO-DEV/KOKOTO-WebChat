 ...
 * FabricRelayHost는 서버간 Relay Protocol 2.x의 설정·호스트 계약·전송 데이터를 담당한다.
 * FabricRelayHost participates in configuration, host contracts, or transport data for Relay Protocol 2.x.
 *
