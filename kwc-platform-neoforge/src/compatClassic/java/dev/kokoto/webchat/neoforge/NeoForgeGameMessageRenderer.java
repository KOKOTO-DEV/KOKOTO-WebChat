 ...
 * NeoForgeGameMessageRenderer는 Minecraft/loader 버전 차이를 흡수하는 NeoForge compatibility shim이다.
 * NeoForgeGameMessageRenderer is a NeoForge compatibility shim absorbing Minecraft/loader API differences across target versions.
 *
...
/** Minecraft 1.20.2-1.21.4 native chat-component renderer used by the NeoForge platform. */
final class NeoForgeGameMessageRenderer {
    private static final Pattern URL_PATTERN = Pattern.compile("(?i)((?:https?://|www\\.)[^\\s<>\"]+)");

    private NeoForgeGameMessageRenderer() {}
