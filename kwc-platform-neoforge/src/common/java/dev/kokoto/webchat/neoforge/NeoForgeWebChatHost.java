 ...
 * NeoForgeWebChatHost는 loader-neutral core와 실제 서버/맵 플랫폼 구현 사이의 경계 인터페이스 또는 bridge다.
 * NeoForgeWebChatHost is a boundary interface/bridge between loader-neutral core and the concrete server/map-platform implementation.
 *
...
public final class NeoForgeWebChatHost implements WebChatHost {
    private final KwcNeoForgeRuntime runtime;
    private final CoreLogger logger;
    private final WebPushHost push;
    public NeoForgeWebChatHost(KwcNeoForgeRuntime runtime) {
        this.runtime = runtime;
        this.logger = CoreLogger.of(runtime::info, runtime::warn);
        this.push = new NeoForgeWebPushHost(runtime);
    }
