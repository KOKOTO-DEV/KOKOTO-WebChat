 ...
 * NeoForgeConversationStoreHost는 loader-neutral core와 실제 서버/맵 플랫폼 구현 사이의 경계 인터페이스 또는 bridge다.
 * NeoForgeConversationStoreHost is a boundary interface/bridge between loader-neutral core and the concrete server/map-platform implementation.
 *
...
public final class NeoForgeConversationStoreHost implements ConversationStoreHost {
    private final KwcNeoForgeRuntime runtime;
    public NeoForgeConversationStoreHost(KwcNeoForgeRuntime runtime) { this.runtime = runtime; }
    ...
    public PlayerIdentity resolveIdentity(String uuid) {
        ...
        try {
            ...
            if (online != null) {
                String username = NeoForgeCompat.profileName(online);
