 ...
 * NeoForgePl3xMapAdapterHost는 loader-neutral core와 실제 서버/맵 플랫폼 구현 사이의 경계 인터페이스 또는 bridge다.
 * NeoForgePl3xMapAdapterHost is a boundary interface/bridge between loader-neutral core and the concrete server/map-platform implementation.
 *
...
/** NeoForge resource/filesystem/logging bridge for the loader-neutral pl3xmap adapter. */
public final class NeoForgePl3xMapAdapterHost implements Pl3xMapAdapterHost {
    private final KwcNeoForgeRuntime runtime;
    private final CoreLogger logger;

    public NeoForgePl3xMapAdapterHost(KwcNeoForgeRuntime runtime) {
