 ...
 * NeoForgeYamlConfiguration는 NeoForge 런타임에서 KWC core 기능을 해당 loader/Minecraft API에 연결한다.
 * NeoForgeYamlConfiguration connects KWC core behavior to the concrete NeoForge/Minecraft runtime APIs.
 *
