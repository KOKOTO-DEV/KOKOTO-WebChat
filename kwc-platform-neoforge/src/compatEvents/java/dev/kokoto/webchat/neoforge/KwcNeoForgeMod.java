 ...
 * KwcNeoForgeMod는 Minecraft/loader 버전 차이를 흡수하는 NeoForge compatibility shim이다.
 * KwcNeoForgeMod is a NeoForge compatibility shim absorbing Minecraft/loader API differences across target versions.
 *
