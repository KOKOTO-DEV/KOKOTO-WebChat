...
public final class ForgeCompat {
 private ForgeCompat(){}
 public static String profileName(ServerPlayer p){ return p.getGameProfile().getName(); }
 public static boolean isOperator(MinecraftServer s, ServerPlayer p){ try { return s != null && s.getPlayerList().isOp(p.getGameProfile()); } catch(Throwable x){ return false; } }
 public static Component text(String s){ return new TextComponent(String.valueOf(s)); }
