 ...
 * ForgeDiscordBridge는 Forge 런타임에서 KWC core 기능을 해당 loader/Minecraft API에 연결한다.
 * ForgeDiscordBridge connects KWC core behavior to the concrete Forge/Minecraft runtime APIs.
 *
