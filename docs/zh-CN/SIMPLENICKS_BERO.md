...
KOKOTO WebChat 5.1.0 在 **Bukkit/Paper 系列**服务器上可以使用 [SimpleNicks-Bero](https://github.com/KOKOTO-DEV/SimpleNicks-Bero) 写入 Bukkit player display name 的昵称。KWC 不把 SimpleNicks 作为硬依赖，也不会直接读取该插件的数据库。
