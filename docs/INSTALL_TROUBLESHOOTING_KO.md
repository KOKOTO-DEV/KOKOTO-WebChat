...
공개 서버에서는 Caddy 또는 nginx를 통한 HTTPS 사용을 권장합니다. Caddy는 `docs/CADDY_HTTPS_KO.md`와 `examples/caddy/Caddyfile`, nginx는 `docs/NGINX_HTTPS_KO.md`와 `examples/nginx/kchat.conf`를 참고하세요.
