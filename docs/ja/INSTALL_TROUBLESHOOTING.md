...
> `validate-release-windows.bat`、必要な PowerShell helper、`validation/` 配下の開発用 regression harness は source archive に含まれます。release build のために別の validation-tools package は必要ありません。
