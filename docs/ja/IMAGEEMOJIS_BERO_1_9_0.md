...
KOKOTO WebChat 5.3.0 は [ImageEmojis-Bero](https://github.com/KOKOTO-DEV/ImageEmojis-Bero) と任意で連携できます。サーバー側 runtime glyph 連携は **Bukkit/Paper 系**が対象で、現在の 1.9.x Bero 系列（1.9.2 を含む）を基準に確認しています。reflection ベースのため hard dependency はありません。
