...
KOKOTO WebChat 5.3.0 は **Bukkit/Paper 系**で [SimpleNicks-Bero](https://github.com/KOKOTO-DEV/SimpleNicks-Bero) が Bukkit の player display name に適用した nickname を利用できます。KWC は SimpleNicks を hard dependency とせず、plugin の database も直接読みません。
