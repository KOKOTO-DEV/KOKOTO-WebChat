...
This guide covers everyday use. For server deployment and maintenance see `INSTALLATION_OPERATIONS_EN.md`; for implementation details see `TECHNICAL_REFERENCE_EN.md`; the long-form reference is `COMPLETE_REFERENCE_EN.md`.
...
For implementation/security details and external standards, see [TECHNICAL_REFERENCE_EN.md](TECHNICAL_REFERENCE_EN.md) and [REFERENCES.md](REFERENCES.md).
