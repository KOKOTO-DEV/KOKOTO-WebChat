# KOKOTO WebChat 5.3.1 — References and Standards
...
- Historical KWC documents remain historical; do not use an older document as the definition of current 5.3.1 behavior.
