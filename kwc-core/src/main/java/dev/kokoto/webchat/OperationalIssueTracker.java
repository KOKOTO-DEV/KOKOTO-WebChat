 ...
 * OperationalIssueTracker는 여러 저수준 객체를 조합해 하나의 KWC 기능 흐름을 수행하는 서비스/관리 계층이다.
 * OperationalIssueTracker is a service/manager layer coordinating lower-level objects into one KWC feature flow.
 *
