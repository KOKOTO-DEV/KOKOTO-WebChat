 ...
 * ContentFilterConfigParser는 메시지 moderation/content-filter 파이프라인의 일부다.
 * ContentFilterConfigParser is part of the message moderation/content-filter pipeline.
 *
