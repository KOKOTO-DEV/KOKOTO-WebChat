 ...
 * SquaremapAdapterHost는 loader-neutral core와 실제 서버/맵 플랫폼 구현 사이의 경계 인터페이스 또는 bridge다.
 * SquaremapAdapterHost is a boundary interface/bridge between loader-neutral core and the concrete server/map-platform implementation.
 *
...
/** Loader-neutral filesystem/resource surface required by the squaremap web adapter. */
public interface SquaremapAdapterHost {
